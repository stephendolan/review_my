class Shared::FlashMessages < BaseComponent
  ...
  def render
    ...
    div class: "bg-indigo-900 text-center py-4 lg:px-4" do
      flash.each do |flash_type, flash_message|
        div class: "p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-lg flex lg:inline-flex", role: "alert", flow_id: "flash" do
