        ...
        if (user = activity.creator)
          ...
          div class: "flex-1 space-y-1" do
            div class: "flex items-center justify-between" do
              h3 "You", class: "text-sm font-medium leading-5"
              para "1h", class: "text-sm leading-5 text-gray-500"
            end
            para "Deployed Workcation (2d89f0c8 in master) to production", class: "text-sm leading-5 text-gray-500"
          end
