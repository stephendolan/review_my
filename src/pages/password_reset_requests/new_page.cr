    ...
    form_for PasswordResetRequests::Create, class: "bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" do
      ...
      div class: "mt-4" do
        div class: "flex items-center justify-between" do
          submit "Reset Password", class: "bg-indigo-500 hover:bg-indigo-700 text-gray-100 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline cursor-pointer", flow_id: "request-password-reset-button"
        end
      end
    end
  end
