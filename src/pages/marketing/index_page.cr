              ...
              div class: "sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left" do
                ...
                div class: "mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start" do
                  div class: "rounded-md shadow" do
                    link "Get Started", to: SignUps::New, class: "w-full flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-gray-100 bg-indigo-600 hover:bg-indigo-500 hover:text-gray-100 focus:outline-none focus:shadow-outline md:py-4 md:text-lg md:px-10"
                  end
                  div class: "ml-3 inline-flex" do
                    link "Sign In", to: SignIns::New, class: "w-full flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-gray-100 bg-indigo-600 hover:bg-indigo-500 hover:text-gray-100 focus:outline-none focus:shadow-outline md:py-4 md:text-lg md:px-10"
                  end
                end
              end
